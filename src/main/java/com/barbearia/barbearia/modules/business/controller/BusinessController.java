...
public class BusinessController {
    ...
    @PatchMapping("/me/slot-interval")
    public ResponseEntity<Void> updateSlotInterval(@RequestBody @Valid UpdateSlotIntervalRequest request) {
        businessService.updateSlotInterval(request);
